...
# Extract images from ZIP into a list
...
def save_as_pickle_small(dataset):
    # save smaller version of the dataset
    dataset = dataset[:10]
    import pickle
...
if __name__ == "__main__":
    ...
    # Define dataset path
    zip_path = "./0.zip" # replace this with whatever path you saved the zipfile from padchest
    #define labels path
    csv_path = './PADCHEST_labels.csv'
